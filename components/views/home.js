            ...
            <div className="container col-xs-12">
            {
                !!home.blurbs && home.blurbs.map((blurb, index) => 
                    <div key={`blurb_${index}`} className="col-sm-4 text-center">
                        ...
                        <div className="img-circle center-block" style={{ background: `url(${`http://localhost:3000/static/assets/${blurb.children[0].value}`})`, backgroundSize:'cover', height: '300px', width: '300px' }}>
                        </div>
